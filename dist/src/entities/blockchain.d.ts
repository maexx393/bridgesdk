...
export declare class Blockchain {
    ...
    static readonly ALGORAND: Blockchain;
...
declare const ALGORAND: Blockchain;
...
export { ETHEREUM, AVALANCHE, SMART_CHAIN, MOONBASE_ALPHA, MUMBAI, MATIC, HECO, FANTOM, ALGORAND, SHIDEN, IOTEX, HARMONY, CRONOS, OKEX, MULTIVAC, METIS_NETWORK, MOONBEAM };
